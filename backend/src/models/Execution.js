/**
 * @fileoverview Execution persistence model.
 *
 * Stores the same execution detail shape returned by the REST API while
 * keeping Mongoose metadata out of API responses.
 *
